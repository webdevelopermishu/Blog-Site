...
<body>
    ...
    <div class="sidebar-body">
        ...
        <li class="nav-item nav-category">Elements</li>
            ...
            <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#authePages" role="button" aria-expanded="false" aria-controls="authePages">
            <i class="link-icon" data-feather="align-center"></i>
            <span class="link-title">Tags</span>
            <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse" id="authePages">
                <ul class="nav sub-menu n">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="2" href="{{ route('tag.trash') }}">
                        <i class="link-icon" data-feather="trash"></i>
                        <span class="link-title">Trash</span>
                        </a>
                    </li>
        ...
        <li class="nav-item nav-category">Editors</li>
            <li class="nav-item">
            @can('requests_allow')
            <a class="nav-link" data-toggle="collapse" href="#aPages" role="button" aria-expanded="false" aria-controls="authPages">
            <i class="link-icon" data-feather="layout"></i>
            <span class="link-title">Requests</span>
            <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse" id="aPages">
            <ul class="nav sub-menu">
                <li class="nav-item">
                    <a class="nav-link"  href="{{ route('auth.req') }}">
                    <i class="link-icon" data-feather="activity"></i>
                    <span class="link-title">Author Requests</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('auth.list') }}" class="nav-link">
                    <i class="link-icon" data-feather="list"></i>
                    <span class="link-title">Authors List</span>
                    </a>
                </li>
            </ul>
            @endcan
            ...
            <li class="nav-item">
                ...
                <i class="link-icon" data-feather="list"></i>
                <span class="link-title">Social Manage</span>
                </a>
            </li>
        </li>
